...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate: CAR, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    # Keep unvalidated angle-LKAS platforms in dashcam mode. This experimental port only enables the tested vehicle.
    if ret.flags & SubaruFlags.LKAS_ANGLE and candidate != CAR.SUBARU_OUTBACK_2023:
